...
public class UtilityClass 
{
	...
	{
		FileInputStream file= new FileInputStream("D:\\eclipse\\LivingLiquidz\\TestData\\LivingLiquidz.xlsx");
	...
	{
		FileInputStream file=new  FileInputStream("D:\\eclipse\\LivingLiquidz\\LivingLiquidz.properties");
	...
	public static void getScrenshot(WebDriver driver,int TestCaseId) throws IOException
	{
		...
		File des= new File("D:\\eclipse\\LivingLiquidz\\FailedTestCaseSS\\TestCaseId"+TestCaseId+".png");
